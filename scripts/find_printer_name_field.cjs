...
console.log('Archivos con "Nombre de Impresora Principal" o "printerName":');
searchDir(srcDir, /Nombre de Impresora Principal|printerName/i).forEach(f => console.log(' -', f));
