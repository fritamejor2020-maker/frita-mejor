...
export const generateZReportHTML = (shift, sales, expenses, customers, customerTypes, ticketConfig = {}, cashDrawerCode = '', paymentMethods = []) => {
  ...
  const contrataTotalNeto = contrataCashNeto + contrataTotalTransfer + contrataCredit;
  ...
  const expectedCash = initial + localCash + contrataCash - totalExpenses + totalDeposits;
  ...
  return `
    <div style="width: 76mm; color: black; font-family: 'Courier New', Courier, monospace; font-size: 11px; line-height: 1.2; padding: 4px; margin: 0 auto;">
      ...
      <!-- 1. DESGLOSE POR CLIENTE CONTRATA (SI APLICA) -->
      ...
      <!-- 2. RESUMEN FINANCIERO DEL TURNO -->
      ...
      <div style="font-size: 10.5px; font-weight: bold; margin-bottom: 6px; display: flex; flex-direction: column; gap: 3px;">
        ...
        <div style="margin-bottom: 2px;">
          ...
          <div style="display: flex; justify-content: space-between;"><span>Salidas Local:</span><span>${localSalidasAbsorbidas > 0 ? `-${formatMoney(localSalidasAbsorbidas)}` : '$ 0'}</span></div>
        ...
        <div style="margin-bottom: 2px;">
          ...
          <div style="display: flex; justify-content: space-between;"><span>Salidas Contratas:</span><span>${contrataSalidasAbsorbidas > 0 ? `-${formatMoney(contrataSalidasAbsorbidas)}` : '$ 0'}</span></div>
